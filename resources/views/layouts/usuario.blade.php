...
<body class="h-full grid grid-cols-12">
    ...
    <button id="toggleSidebar"
        class="fixed top-1/2 left-0 bg-[#73767a97] text-white rounded-r-md p-2 z-50 lg:hidden transform transition-transform duration-300">
        <!-- Icono del botón -->
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            class="icon icon-tabler icons-tabler-outline icon-tabler-chevron-compact-right" id="arrow">
    ...
    <!-- Contenido principal -->
    <main class="col-span-12 lg:col-start-3 lg:col-span-10 ml-auto w-full">
        @yield('content')
    </main>
</body>
<script>
